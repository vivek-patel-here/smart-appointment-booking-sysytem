...
function Appointment({fetchAppointments}) {
  ...
  return (
     ...
     <div className='appointment'>
      <h1>Appointments </h1>
     {appoint.length!=0 && <div className="row-bold row">
        <p>Name</p>
        <p>mobile</p>
        <p>Date</p>
        <p>Time</p>
    ...
    {appoint.length!=0 && appoint.map((appointment)=>{
      return (<div className="row" key={appointment._id}>
         ...
         {!appointment.notactive && <select name="status" onChange={(e)=>{changeStatus(e,appointment._id)}}>
            <option value="Pending">Pending</option>
            <option value="Granted">Granted</option>
            <option value="Cancelled By Shop">Cancelled By Shop</option>
